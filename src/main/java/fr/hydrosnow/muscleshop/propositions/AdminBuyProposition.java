...
public class AdminBuyProposition implements Proposition {
	private UUID uuid;
	private ItemStack itemStack;
	private double price;

	public AdminBuyProposition(final ItemStack s, final double p) {
		loadFromReferences(s, p);
	}

	public AdminBuyProposition(final Map<String, Object> m) {
		loadFromMap(m);
	}
