...
public class PlayerBuyProposition implements Proposition {
	private UUID uuid;
	private OfflinePlayer player;
	private ItemStack itemStack;
	private double price;

	public PlayerBuyProposition(final OfflinePlayer p, final ItemStack s, final double d) {
		loadFromReferences(p, s, d);
	}

	public PlayerBuyProposition(final Map<String, Object> m) {
		loadFromMap(m);
	}
